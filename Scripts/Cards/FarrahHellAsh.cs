...
public class FarrahHellAsh : XilaCardModel
{
    ...
    {
        await PowerCmd.Apply<FarrahHellAshPower>(choiceContext, Owner.Creature, DynamicVars["Guard"].BaseValue, Owner.Creature, this);
    }
