...
[RegisterCharacterStarterCard(typeof(XilaCharacter), 1, Order = 4)]
public class MoonlightShield : XilaCardModel
{
	...
	public MoonlightShield() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary) { }
