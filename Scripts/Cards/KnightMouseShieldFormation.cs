...
/// 骑士鼠的盾阵
/// spec: 2cost [稀有能力牌]
/// (固有。)格挡不再在你的回合开始时消失。护卫层数清空时此效果失效。
/// </summary>
[RegisterCard(typeof(XilaCardPool))]
public class KnightMouseShieldFormation : XilaCardModel
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<KnightMouseShieldFormationPower>(choiceContext, Owner.Creature, 1m, Owner.Creature, this);
    }
